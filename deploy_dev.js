...
/*
 * Deploy talkilla-stage.mozillalabs.com, for fun and profit.
 */
...
const INSTANCE_TYPE = process.env['INSTANCE_TYPE'] || 't1.micro'; //'m1.small';

const CERT_PEM  = process.env.TALKILLA_SSL_PUB          || '~/cert.pem';
const KEY_PEM   = process.env.TALKILLA_SSL_PRIV         || '~/key.pem';
const SMTP_JSON = process.env.TALKILLA_EPHEMERAL_CONFIG || '~/smtp.json';
